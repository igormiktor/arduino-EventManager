...
// Using the GenericListeners branch of arduino-EventManager
// https://github.com/igormiktor/arduino-EventManager/tree/GenericListeners
...
void setup() 
{
    ...
    eventManager.addListener( EventManager::kEventUser0, &listenerFreeFunction );
